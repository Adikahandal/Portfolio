...
const ItemLayout = ({ children, className }) => {
    return <div className={clsx('custom-bg2 p-8 rounded-xl  flex items-center justify-center space-y-8', className)}>
        {children}
    </div>
}
        ...
        <section className='py-10 w-full'>
            <div className='grid grid-cols-12 gap-8 w-full'>
                <ItemLayout className={"col-span-8 row-span-2 flex-col items-start"}>
                    <h2 className='text-2xl text-left w-full capitalize'>Conjurer of MERN spells</h2>
                ...
                <ItemLayout className={"col-span-4 text-yellow_accent"}>
                ...
                <ItemLayout className={"col-span-7 !p-0"}>
                ...
                <ItemLayout className={"col-span-full !p-6"}>
                    <img className='w-full h-40' src='https://skillicons.dev/icons?i=js,html,css,angular,cpp,mongodb,mysql,nextjs,py,threejs&theme=light' alt='Aditya Kahandal' loading='lazy' />
                </ItemLayout>
